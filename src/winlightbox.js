...
(function() {
    ...
    $.fn.winLightBox = function(settings) {
		...
		win.create = function(){
			$("body").prepend("<div id=\"winlightbox-container\"></div>");
		...
		if(settings!=null){
			...
			win.init = function(){
				...
				this.positionHorizontal = "center"; //left, center, right
				this.positionVertical = "center"; //top, center, bottom
			}
			win.init();
		}
